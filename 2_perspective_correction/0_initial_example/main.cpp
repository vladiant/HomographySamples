...
void decomposeHomography(const string &img1Path, const string &img2Path,
                         const Size &patternSize, const float squareSize,
...
int main(int argc, char *argv[]) {
  ...
  decomposeHomography(parser.get<String>("image1"),
                      parser.get<String>("image2"), patternSize, squareSize,
